...
UPDATE `creature_text_locale` SET `CreatureID`='15263', `GroupID`='1', `ID`='0', `Locale`='esES', `text`='¡Que vuestra muerte sirva de ejemplo!' WHERE (`CreatureID`='15263') AND (`GroupID`='1') AND (`ID`='0');
...
UPDATE `creature_text_locale` SET `CreatureID`='15516', `GroupID`='1', `ID`='0', `Locale`='esES', `text`='¡Os condeno a morir!' WHERE (`CreatureID`='15516') AND (`GroupID`='1') AND (`ID`='0');
