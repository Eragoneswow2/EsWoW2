...
-- Kalecgos --
¡Vuestro dolor no ha hecho más que comenzar!
¡Kil'jaeden debe ser destruido!
Madrigosa merecía un destino mejor. Hicisteis lo que teníais que hacer, pero esta batalla aún no ha acabado.

-- Sathrovarr el Corruptor --
¡Sathrovarr induce a Malygos a un estado de ira enloquecida!

-- Protector filosol --
Presencia enemiga detectada.
Detectada amenaza cercana. Abandonando modo de ahorro de energía.
Unidad entrando en modo ahorro de energía.
La unidad está ahora operativa y atacando objetivos.

-- Explorador Filosol --
¡Enemigos avistados! ¡Atacad mientras intento activar un protector!

-- Brumavil --
%s respira hondo.

-- Comandante Espada Sombría --
¡Traed a los diablillos!

-- Vencedor Espada Sombría --
¡Intrusos! ¡No dejéis que entren en el Sagrario!

-- Profeta Velen --
Héroes mortales, vuestra victoria de hoy aquí fue profetizada hace mucho. El angustiado grito de derrota de mi hermano resonará en el universo y llevará una esperanza renovada a todos los que aún se enfrentan a la Legión Ardiente.
Mientras se acerca la derrota definitiva de la Legión, sentíos orgullosos sabiendo que habéis salvado incontables mundos de la llama.
Del mimo modo que marca un final, este día también anuncia un nuevo comienzo...
La criatura Entropius, a quién os habéis visto obligados a destruir, fue otrora el noble naaru M'uru. En vida, M'uru canalizó grandes energías de LUZ y ESPERANZA. Durante algún tiempo, algunos descaminados intentaron robar esas energías...
¡La buena noticia es que he recuperado la chispa del noble naaru del lugar en que cayó! Donde hay fe nunca se pierde la esperanza, joven elfa de sangre.
¡Observad ahora, mortales, el CORAZÓN DE M'URU! Inmaculado. Bañado por la luz de la creación, como en el amanecer.
Con el tiempo, la luz y la esperanza que contiene renacerán para ser más que esta simple fuente de poder... Quizá revivan el alma de una nación.
La salvación, joven. Es lo que nos espera a todos.
Adiós...

-- Lady Liadrin --
Nuestra arrogancia fue imperdonable. Condenamos a uno de los seres más nobles jamás conocidos. Nunca expiaremos este pecado.
¿Es posible...?
¡Benditos antepasados! Lo siento... tanto amor... tanta gracia... no hay... palabras... es imposible describirlo...

-- Kil'jaeden --
¡Vaciad a la chica! ¡Drenad su poder hasta que no quede más que una cáscara vacía!
...
UPDATE `creature_text_locale` SET `CreatureID`='25319', `GroupID`='6', `ID`='0', `Locale`='esES', `Text`='¡Déjate llevar! ¡Tienes que convertirte en lo que el destino ha decidido que debes ser! ¡Es el momento Anveena!\r\n¡Déjate llevar! ¡Tienes que convertirte en lo que el destino ha decidido que debes ser! ¡Es el momento Anveena!' WHERE (`CreatureID`='25319') AND (`GroupID`='6') AND (`ID`='0');
...
-- Madrigosa --
UPDATE `creature_text_locale` SET `CreatureID`='24895', `GroupID`='0', `ID`='0', `Locale`='esES', `Text`='¡Esperad, amigos! ¡Tenemos información que obtener antes de que este demonio se enfrente a su destino!' WHERE (`CreatureID`='24895') AND (`GroupID`='0') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='24895', `GroupID`='1', `ID`='0', `Locale`='esES', `Text`='¿Dónde está Anveena, demonio? ¿Qué ha sido de Kalec?' WHERE (`CreatureID`='24895') AND (`GroupID`='1') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='24895', `GroupID`='2', `ID`='0', `Locale`='esES', `Text`='¡Me dirás dónde están!' WHERE (`CreatureID`='24895') AND (`GroupID`='2') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='24895', `GroupID`='3', `ID`='0', `Locale`='esES', `Text`='¡Habla! ¡Me estoy hartando de preguntar!' WHERE (`CreatureID`='24895') AND (`GroupID`='3') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='24895', `GroupID`='4', `ID`='0', `Locale`='esES', `Text`='Malygos, señor... hice... lo que... pude.' WHERE (`CreatureID`='24895') AND (`GroupID`='4') AND (`ID`='0');

-- Brutallus --
UPDATE `creature_text_locale` SET `CreatureID`='24882', `GroupID`='0', `ID`='0', `Locale`='esES', `Text`='¡Endebles lagartijas! ¡La muerte es la única respuesta que encontraréis aquí!' WHERE (`CreatureID`='24882') AND (`GroupID`='0') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='24882', `GroupID`='1', `ID`='0', `Locale`='esES', `Text`='¡Bah! ¡Vuestra magia es débil!' WHERE (`CreatureID`='24882') AND (`GroupID`='1') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='24882', `GroupID`='2', `ID`='0', `Locale`='esES', `Text`='¡Te aplastaré!' WHERE (`CreatureID`='24882') AND (`GroupID`='2') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='24882', `GroupID`='3', `ID`='0', `Locale`='esES', `Text`='¡Ha sido divertido, pero sigue esperando un auténtico reto!' WHERE (`CreatureID`='24882') AND (`GroupID`='3') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='24882', `GroupID`='4', `ID`='0', `Locale`='esES', `Text`='¡Venid a probar suerte!' WHERE (`CreatureID`='24882') AND (`GroupID`='4') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='24882', `GroupID`='5', `ID`='0', `Locale`='esES', `Text`='¡Ah, más corderos al matadero!' WHERE (`CreatureID`='24882') AND (`GroupID`='5') AND (`ID`='0');
...
-- Brumavil --
UPDATE `creature_text_locale` SET `CreatureID`='25038', `GroupID`='0', `ID`='0', `Locale`='esES', `Text`='¡Gloria a Kil\'jaeden! ¡Muerte a sus oponentes!' WHERE (`CreatureID`='25038') AND (`GroupID`='0') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='25038', `GroupID`='1', `ID`='0', `Locale`='esES', `Text`='¡Mato por el maestro!' WHERE (`CreatureID`='25038') AND (`GroupID`='1') AND (`ID`='0');
...
-- Lady Sacrolash: mal añadido por parte de TrinityCore, ya que todos los textos de cada entrada en realidad es en un solo. Han dividido una frase en cuatro entradas diferentes. --
UPDATE `creature_text_locale` SET `CreatureID`='25165', `GroupID`='0', `ID`='0', `Locale`='esES', `Text`='Miseria...' WHERE (`CreatureID`='25165') AND (`GroupID`='0') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='25165', `GroupID`='1', `ID`='0', `Locale`='esES', `Text`='Confusión...' WHERE (`CreatureID`='25165') AND (`GroupID`='1') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='25165', `GroupID`='2', `ID`='0', `Locale`='esES', `Text`='Recelo...' WHERE (`CreatureID`='25165') AND (`GroupID`='2') AND (`ID`='0');
...
UPDATE `creature_text_locale` SET `CreatureID`='25165', `GroupID`='9', `ID`='0', `Locale`='esES', `Text`='¡Fuego para ayudar a las sombras!' WHERE (`CreatureID`='25165') AND (`GroupID`='9') AND (`ID`='0');

-- Bruja suprema Alythess: mal añadido por parte de TrinityCore, ya que todos los textos de cada entrada en realidad es en un solo. Han dividido una frase en cuatro entradas diferentes. --
UPDATE `creature_text_locale` SET `CreatureID`='25166', `GroupID`='0', `ID`='0', `Locale`='esES', `Text`='Depravación...' WHERE (`CreatureID`='25166') AND (`GroupID`='0') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='25166', `GroupID`='1', `ID`='0', `Locale`='esES', `Text`='Odio...' WHERE (`CreatureID`='25166') AND (`GroupID`='1') AND (`ID`='0');
...
UPDATE `creature_text_locale` SET `CreatureID`='26046', `GroupID`='1', `ID`='0', `Locale`='esES', `Text`='Pero estoy... perdida. No encuentro el camino de vuelta.' WHERE (`CreatureID`='26046') AND (`GroupID`='1') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='26046', `GroupID`='2', `ID`='0', `Locale`='esES', `Text`='Kalec... ¿Kalec?' WHERE (`CreatureID`='26046') AND (`GroupID`='2') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='26046', `GroupID`='3', `ID`='0', `Locale`='esES', `Text`='¡La pesadilla ha terminado! ¡El hechizo se ha roto! ¡Adiós Kalec, amor mío!' WHERE (`CreatureID`='26046') AND (`GroupID`='3') AND (`ID`='0');

-- Kil'jaeden --
UPDATE `creature_text_locale` SET `CreatureID`='25315', `GroupID`='0', `ID`='0', `Locale`='esES', `Text`='¡Nooooooooo!' WHERE (`CreatureID`='25315') AND (`GroupID`='0') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='25315', `GroupID`='1', `ID`='0', `Locale`='esES', `Text`='¡Un paso más hacia la destrucción!' WHERE (`CreatureID`='25315') AND (`GroupID`='1') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='25315', `GroupID`='1', `ID`='1', `Locale`='esES', `Text`='¡Anakh Kyree!' WHERE (`CreatureID`='25315') AND (`GroupID`='1') AND (`ID`='1');
UPDATE `creature_text_locale` SET `CreatureID`='25315', `GroupID`='2', `ID`='0', `Locale`='esES', `Text`='¿En quién podéis confiar?' WHERE (`CreatureID`='25315') AND (`GroupID`='2') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='25315', `GroupID`='2', `ID`='1', `Locale`='esES', `Text`='¡El enemigo está entre vosotros!' WHERE (`CreatureID`='25315') AND (`GroupID`='2') AND (`ID`='1');
UPDATE `creature_text_locale` SET `CreatureID`='25315', `GroupID`='3', `ID`='0', `Locale`='esES', `Text`='Los prescindibles han muerto. ¡Que así sea! ¡Ahora triunfaré donde Sargeras no lo logró! ¡Desangraré este despreciable mundo y me aseguraré mi puesto como verdadero maestro de la Legión Ardiente! ¡El final ha llegado! ¡Dejad que se desvele el misterio de este mundo!' WHERE (`CreatureID`='25315') AND (`GroupID`='3') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='25315', `GroupID`='4', `ID`='0', `Locale`='esES', `Text`='¡CAOS!' WHERE (`CreatureID`='25315') AND (`GroupID`='4') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='25315', `GroupID`='4', `ID`='1', `Locale`='esES', `Text`='¡DESTRUCCIÓN!' WHERE (`CreatureID`='25315') AND (`GroupID`='4') AND (`ID`='1');
UPDATE `creature_text_locale` SET `CreatureID`='25315', `GroupID`='4', `ID`='2', `Locale`='esES', `Text`='¡OLVIDO!' WHERE (`CreatureID`='25315') AND (`GroupID`='4') AND (`ID`='2');
UPDATE `creature_text_locale` SET `CreatureID`='25315', `GroupID`='5', `ID`='0', `Locale`='esES', `Text`='¡No seré rechazado! ¡Este mundo caerá!' WHERE (`CreatureID`='25315') AND (`GroupID`='5') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='25315', `GroupID`='6', `ID`='0', `Locale`='esES', `Text`='¡No alberguéis falsas esperanzas! ¡No podéis ganar!' WHERE (`CreatureID`='25315') AND (`GroupID`='6') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='25315', `GroupID`='7', `ID`='0', `Locale`='esES', `Text`='¡Agggh! ¡Los poderes de La Fuente del Sol... se vuelven... contra mí! ¿Qué habéis hecho? ¿¿QUÉ HABÉIS HECHO??' WHERE (`CreatureID`='25315') AND (`GroupID`='7') AND (`ID`='0');
UPDATE `creature_text_locale` SET `CreatureID`='25315', `GroupID`='8', `ID`='0', `Locale`='esES', `Text`='%s comienza a canalizar energía oscura.' WHERE (`CreatureID`='25315') AND (`GroupID`='8') AND (`ID`='0');